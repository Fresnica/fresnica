...
///
/// React Native may provide reviewed XDR, an encrypted signer envelope, signer public key, and an
/// app passcode for an explicit fallback/enrollment action. WalletUnlockKey bytes remain inside
/// this native service and are zeroed on a best-effort basis after the Rust Core call.
public final class FresnicaSignerAuthorization {
    ...
    public init(
        core: MobileCoreApiProtocol = MobileCoreApi(),
