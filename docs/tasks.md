...
- [ ] Add provider-backed collection for Hash-X/signed-payload/external signer conditions before claiming general Classic multisig/delegated signing support; already-present valid typed authorization material is recognized
