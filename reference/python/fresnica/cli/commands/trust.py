"""Standalone trustline command handlers."""
...
def execute_trust(
    ...
    try:
        ...
        if args.trust_command == "add":
            ...
            raise ValueError(f"Unknown trust command: {args.trust_command}")
        ...
        service.sign(session.wallet, prepared)
